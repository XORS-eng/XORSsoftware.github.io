...
export default function Home() {
  return (
    <div className="flex min-h-screen items-center justify-center font-sans bg-white">
      <main className="flex min-h-screen w-full max-w-3xl flex-col sm:flex-row items-center justify-center gap-12 py-32 px-16 bg-white sm:items-center">
        <div className="flex flex-col items-start gap-6 text-left max-w-md">
          <h1 className="max-w-xs text-3xl font-semibold leading-10 tracking-tight text-black">
            did u hire a bad engineer? devshop? we're here to save the day
          </h1>
